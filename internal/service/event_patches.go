...
func WorkspacePatch(op, id string, value interface{}) PatchOperation {
...
func WorkspaceSnapshotPatch(value interface{}) PatchOperation {
...
func ExecutionProcessPatch(op, id string, value interface{}) PatchOperation {
...
func ExecutionProcessSnapshotPatch(value interface{}) PatchOperation {
...
func ScratchPatch(op string, value interface{}) PatchOperation {
...
func ScratchRemovePatch(id string, scratchType string) PatchOperation {
	return PatchOperation{
		Op:    "replace",
		Path:  "/scratch",
		Value: map[string]interface{}{"id": id, "payload": map[string]string{"type": scratchType}, "deleted": true},
	}
}

// ApprovalsSnapshotPatch creates a replace patch for the full pending approvals map.
func ApprovalsSnapshotPatch(value interface{}) PatchOperation {
	return PatchOperation{Op: "replace", Path: "/pending", Value: value}
}

// ApprovalCreatedPatch creates an add patch for a new approval.
func ApprovalCreatedPatch(id string, value interface{}) PatchOperation {
...
func MarshalPatchValue(v interface{}) json.RawMessage {
